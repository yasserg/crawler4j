...
public class TagSoupParser extends DefaultHandler implements ScanHandler, XMLReader, LexicalHandler {
    ...
    private static boolean dEFAULTNAMESPACES = true;
    private static boolean dEFAULTIGNOREBOGONS = false;
    private static boolean dEFAULTBOGONSEMPTY = false;
    private static boolean dEFAULTROOTBOGONS = true;
    private static boolean dEFAULTDEFAULTATTRIBUTES = true;
    private static boolean dEFAULTTRANSLATECOLONS = false;
    private static boolean dEFAULTRESTARTELEMENTS = true;
    private static boolean dEFAULTIGNORABLEWHITESPACE = false;
    private static boolean dEFAULTCDATAELEMENTS = true;

    // Feature flags
    private boolean namespaces = dEFAULTNAMESPACES;
    private boolean ignoreBogons = dEFAULTIGNOREBOGONS;
    private boolean bogonsEmpty = dEFAULTBOGONSEMPTY;
    private boolean rootBogons = dEFAULTROOTBOGONS;
    private boolean defaultAttributes = dEFAULTDEFAULTATTRIBUTES;
    private boolean translateColons = dEFAULTTRANSLATECOLONS;
    private boolean restartElements = dEFAULTRESTARTELEMENTS;
    private boolean ignorableWhitespace = dEFAULTIGNORABLEWHITESPACE;
    private boolean cDATAElements = dEFAULTCDATAELEMENTS;
    ...
    **/
    ...
    private Map<String, Boolean> theFeatures = new HashMap<String, Boolean>();

    {
        theFeatures.put(namespacesFeature, truthValue(dEFAULTNAMESPACES));
        ...
        theFeatures.put(ignoreBogonsFeature, truthValue(dEFAULTIGNOREBOGONS));
        theFeatures.put(bogonsEmptyFeature, truthValue(dEFAULTBOGONSEMPTY));
        theFeatures.put(rootBogonsFeature, truthValue(dEFAULTROOTBOGONS));
        theFeatures.put(defaultAttributesFeature, truthValue(dEFAULTDEFAULTATTRIBUTES));
        theFeatures.put(translateColonsFeature, truthValue(dEFAULTTRANSLATECOLONS));
        theFeatures.put(restartElementsFeature, truthValue(dEFAULTRESTARTELEMENTS));
        theFeatures.put(ignorableWhitespaceFeature, truthValue(dEFAULTIGNORABLEWHITESPACE));
        theFeatures.put(CDATAElementsFeature, truthValue(dEFAULTCDATAELEMENTS));
    }
    ...
    public boolean etagCdata(char[] buff, int offset, int length) throws SAXException {
    ...
    public void etagBasic(char[] buff, int offset, int length) throws SAXException {
        theNewElement = null;
        String name;
        if (length != 0) {
