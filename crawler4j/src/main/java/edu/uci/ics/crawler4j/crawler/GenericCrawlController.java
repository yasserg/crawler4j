...
public class GenericCrawlController<CrawlerType extends WebCrawler> {
    ...
    public GenericCrawlController(CrawlConfig config, PageFetcher pageFetcher,
    ...
    public GenericCrawlController(CrawlConfig config, PageFetcher pageFetcher, Parser parser,
                           RobotstxtServer robotstxtServer, TLDList tldList) throws Exception {
        config.validate();
        this.config = config;
