...
public class BasicCrawlController {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * You can set the maximum number of pages to crawl. The default value is -1 for unlimited
         * number of pages
         */
        ...
        /*
         * This config parameter can be used to set your crawl to be resumable (meaning that you can
         * resume the crawl from a previously interrupted/crashed crawl). Note: if you enable
