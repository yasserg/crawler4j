...
public class CrawlController extends Configurable {
	...
	public CrawlController(CrawlConfig config, PageFetcher pageFetcher, RobotstxtServer robotstxtServer) throws CrawlerConfigurationException {
		super(config);
		...
		if (!envHome.exists()) {
			if (envHome.mkdir()) {
				...
				throw new CrawlerConfigurationException("Failed creating the frontier folder: " + envHome.getAbsolutePath());
			}
		}
	...
	public interface WebCrawlerFactory<T extends WebCrawler> {
		T newInstance() throws CrawlerConfigurationException;
	}
	...
	private static class DefaultWebCrawlerFactory<T extends WebCrawler> implements WebCrawlerFactory<T> {
		...
		@Override
		public T newInstance() throws CrawlerConfigurationException {
			try {
				return _c.newInstance();
			} catch (ReflectiveOperationException e) {
				throw new CrawlerConfigurationException("Could not instanciate the crawler.", e);
			}
		}
	}
